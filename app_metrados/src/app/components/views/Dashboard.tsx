...
import { TrendingUp, Users, BookOpen, Activity, AlertTriangle, XCircle, Plus, ArrowRight } from 'lucide-react';
import { kpiData, chartByEspecialidad, actividadReciente, alertas } from '../../data/mockData';
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          <KpiCard
            icon={TrendingUp}
            label="Total Metrado"
            value={kpiData.totalMetrado.toLocaleString('es-PE', { minimumFractionDigits: 2 })}
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="col-span-2 bg-white rounded-xl border p-5 shadow-sm" style={{ borderColor: '#E5E9F0' }}>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={chartByEspecialidad} barGap={4} barSize={22}>
                ...
                <div key={item.id} className="px-5 py-3 hover:bg-[#FAFBFC] transition-colors">
                  <div className="flex items-start gap-3">
                    <div
                      ...
                      style={{ backgroundColor: TIPO_COLORS[item.tipo] + '20' }}
                    >
