...
import { Settings, Database, FileText, AlertCircle, ChevronRight, Clock, Shield } from 'lucide-react';
...
const DATASET_CONFIG = [
  { key: 'proyecto', label: 'Nombre del Proyecto', value: 'Mejoramiento de los Servicios de Salud del Centro de Salud Belempampa', type: 'text' },
  { key: 'expediente', label: 'Código Expediente', value: 'EXP-BELEMPAMPA-001', type: 'code' },
  { key: 'contrato', label: 'N° de Contrato', value: 'CON-2024-BELEMPAMPA', type: 'code' },
  { key: 'inicio', label: 'Fecha de Inicio', value: '15/05/2024', type: 'date' },
  { key: 'plazo', label: 'Plazo (días)', value: '360', type: 'number' },
  { key: 'monto', label: 'Monto Contractual (S/)', value: '15,200,000.00', type: 'currency' },
  { key: 'residente', label: 'Ingeniero Residente', value: 'Ing. Residente Belempampa', type: 'text' },
  { key: 'supervisor', label: 'Supervisor de Obra', value: 'Ing. Supervisor Belempampa', type: 'text' },
];
